...
{
    /// <summary>
    /// Controller for managing home page carousel images in admin area
    ...
    public class HomeImagesController : Controller
    {
        ...
        private readonly ILogger<HomeImagesController> _logger;
        private readonly IWebHostEnvironment _environment;

        /// <summary>
        /// Initializes a new instance of the HomeImagesController
        /// </summary>
        ...
        public HomeImagesController(
            ...
            ILogger<HomeImagesController> logger,
        ...
        /// <summary>
        /// Displays list of all home images
        /// </summary>
        /// <returns>List of home images view</returns>
        public async Task<IActionResult> Index(CancellationToken cancellationToken)
        {
            ...
            try
            {
                var images = await _context.HomeImages
            ...
            {
                _logger.LogError(ex, "Error loading home images");
                TempData["ErrorMessage"] = $"Error loading images: {ex.Message}";
                return View(new List<HomeImage>());
            }
        }

        /// <summary>
        /// Displays form to create a new home image
        /// </summary>
        /// <returns>Create home image view</returns>
        ...
        /// <summary>
        /// Handles creation of a new home image
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        ImagePath = $"/Images/Home/{uniqueFileName}",
                    ...
                    _logger.LogInformation("Adding home image to database: {ImagePath}", homeImage.ImagePath);
                    _context.HomeImages.Add(homeImage);
                    
                    var savedCount = await _context.SaveChangesAsync(cancellationToken);
                    _logger.LogInformation("Saved {Count} changes to database. Image ID: {Id}", savedCount, homeImage.Id);
                ...
                {
                    _logger.LogError(ex, "Error uploading home image: {Message}", ex.Message);
        ...
        /// <summary>
        /// Handles deletion of a home image
        /// </summary>
        ...
        {
            var homeImage = await _context.HomeImages.FindAsync(new object[] { id }, cancellationToken);
            if (homeImage == null)
            {
                return NotFound();
            }
            ...
            try
            {
                ...
                var filePath = Path.Combine(_environment.WebRootPath, homeImage.ImagePath.TrimStart('/'));
            ...
            {
                _logger.LogError(ex, "Error deleting home image");
        ...
        public async Task<IActionResult> UpdateDisplayOrder(int id, int displayOrder, CancellationToken cancellationToken)
        {
            ...
            homeImage.DisplayOrder = displayOrder;
            await _context.SaveChangesAsync(cancellationToken);
        ...
        public async Task<IActionResult> ToggleActive(int id, CancellationToken cancellationToken)
        {
            ...
            homeImage.IsActive = !homeImage.IsActive;
            await _context.SaveChangesAsync(cancellationToken);

            TempData["SuccessMessage"] = $"Image {(homeImage.IsActive ? "activated" : "deactivated")} successfully.";
            return RedirectToAction(nameof(Index));
        }
    }
}
