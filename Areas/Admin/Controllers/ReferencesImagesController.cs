...
{
    /// <summary>
    /// Controller for managing references page carousel images in admin area
    ...
    public class ReferencesImagesController : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<ReferencesImagesController> _logger;
        private readonly IWebHostEnvironment _environment;

        /// <summary>
        /// Initializes a new instance of the ReferencesImagesController
        /// </summary>
        /// <param name="context">Database context</param>
        /// <param name="logger">Logger instance</param>
        /// <param name="environment">Web host environment</param>
        public ReferencesImagesController(
            ApplicationDbContext context,
            ILogger<ReferencesImagesController> logger,
        ...
        /// <summary>
        /// Displays list of all references images
        /// </summary>
        /// <returns>List of references images view</returns>
        public async Task<IActionResult> Index(CancellationToken cancellationToken)
        {
            ...
            try
            {
                var images = await _context.ReferencesImages
            ...
            {
                _logger.LogError(ex, "Error loading references images");
                TempData["ErrorMessage"] = $"Error loading images: {ex.Message}";
                return View(new List<ReferencesImage>());
            }
        }

        /// <summary>
        /// Displays form to create a new references image
        /// </summary>
        /// <returns>Create references image view</returns>
        ...
        /// <summary>
        /// Handles creation of a new references image
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var uploadsFolder = Path.Combine(_environment.WebRootPath, "Images", "References");
                    ...
                    var referencesImage = new ReferencesImage
                    {
                        ImagePath = $"/Images/References/{uniqueFileName}",
                        OriginalFileName = image.FileName,
                        AltText = altText ?? "Havit Group",
                        DisplayOrder = displayOrder,
                        IsActive = isActive,
                        CreatedAt = DateTime.UtcNow
                    };

                    _logger.LogInformation("Adding references image to database: {ImagePath}", referencesImage.ImagePath);
                    _context.ReferencesImages.Add(referencesImage);
                    
                    var savedCount = await _context.SaveChangesAsync(cancellationToken);
                    _logger.LogInformation("Saved {Count} changes to database. Image ID: {Id}", savedCount, referencesImage.Id);
                ...
                {
                    _logger.LogError(ex, "Error uploading references image: {Message}", ex.Message);
        ...
        /// <summary>
        /// Handles deletion of a references image
        /// </summary>
        ...
        {
            var referencesImage = await _context.ReferencesImages.FindAsync(new object[] { id }, cancellationToken);
            if (referencesImage == null)
            {
                return NotFound();
            }
            ...
            try
            {
                ...
                var filePath = Path.Combine(_environment.WebRootPath, referencesImage.ImagePath.TrimStart('/'));
                ...
                _context.ReferencesImages.Remove(referencesImage);
            ...
            {
                _logger.LogError(ex, "Error deleting references image");
        ...
        public async Task<IActionResult> UpdateDisplayOrder(int id, int displayOrder, CancellationToken cancellationToken)
        {
            ...
            referencesImage.DisplayOrder = displayOrder;
            await _context.SaveChangesAsync(cancellationToken);
        ...
        public async Task<IActionResult> ToggleActive(int id, CancellationToken cancellationToken)
        {
            ...
            referencesImage.IsActive = !referencesImage.IsActive;
            await _context.SaveChangesAsync(cancellationToken);

            TempData["SuccessMessage"] = $"Image {(referencesImage.IsActive ? "activated" : "deactivated")} successfully.";
            return RedirectToAction(nameof(Index));
        }
    }
}
