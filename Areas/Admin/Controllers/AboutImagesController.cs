...
{
    /// <summary>
    /// Controller for managing about page carousel images in admin area
    ...
    public class AboutImagesController : Controller
    {
        ...
        private readonly ILogger<AboutImagesController> _logger;
        private readonly IWebHostEnvironment _environment;

        /// <summary>
        /// Initializes a new instance of the AboutImagesController
        /// </summary>
        /// <param name="context">Database context</param>
        /// <param name="logger">Logger instance</param>
        /// <param name="environment">Web host environment</param>
        public AboutImagesController(
            ApplicationDbContext context,
            ILogger<AboutImagesController> logger,
        ...
        /// <summary>
        /// Displays list of all about images
        /// </summary>
        /// <returns>List of about images view</returns>
        public async Task<IActionResult> Index(CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogError(ex, "Error loading about images");
                TempData["ErrorMessage"] = $"Error loading images: {ex.Message}";
                return View(new List<AboutImage>());
            }
        }

        /// <summary>
        /// Displays form to create a new about image
        /// </summary>
        /// <returns>Create about image view</returns>
        ...
        /// <summary>
        /// Handles creation of a new about image
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var uploadsFolder = Path.Combine(_environment.WebRootPath, "Images", "About");
                    ...
                    {
                        ImagePath = $"/Images/About/{uniqueFileName}",
                    ...
                    _logger.LogInformation("Adding about image to database: {ImagePath}", aboutImage.ImagePath);
                    _context.AboutImages.Add(aboutImage);
                    
                    var savedCount = await _context.SaveChangesAsync(cancellationToken);
                    _logger.LogInformation("Saved {Count} changes to database. Image ID: {Id}", savedCount, aboutImage.Id);
                ...
                {
                    _logger.LogError(ex, "Error uploading about image: {Message}", ex.Message);
        ...
        /// <summary>
        /// Handles deletion of an about image
        /// </summary>
        ...
        {
            var aboutImage = await _context.AboutImages.FindAsync(new object[] { id }, cancellationToken);
            if (aboutImage == null)
            {
                return NotFound();
            }
            ...
            try
            {
                ...
                var filePath = Path.Combine(_environment.WebRootPath, aboutImage.ImagePath.TrimStart('/'));
            ...
            {
                _logger.LogError(ex, "Error deleting about image");
        ...
        public async Task<IActionResult> UpdateDisplayOrder(int id, int displayOrder, CancellationToken cancellationToken)
        {
            ...
            aboutImage.DisplayOrder = displayOrder;
            await _context.SaveChangesAsync(cancellationToken);
        ...
        public async Task<IActionResult> ToggleActive(int id, CancellationToken cancellationToken)
        {
            ...
            TempData["SuccessMessage"] = $"Image {(aboutImage.IsActive ? "activated" : "deactivated")} successfully.";
            return RedirectToAction(nameof(Index));
        }
    }
}
